# 💕 Since February 6th — Our Story, Arooba's 3D Romantic Keepsake Book
...
**Since February 6th** is a hyper-realistic 3D romantic keepsake book crafted in Vanilla HTML5, CSS3, and JavaScript, telling our story for Arooba starting from the day we got engaged. Designed with meticulous attention to typography, tactile physics, atmospheric lighting, and audio synthesis, it delivers an unforgettable interactive journey across 12 heartfelt chapters.

The experience starts with a closed, leather-bound, gold-filigreed 3D hardcover tome resting in gentle candlelight. Upon opening, the front cover swings open in 3D to reveal a two-page spread: a left-hand memory keepsake polaroid and a right-hand stack of 12 deckled page leaves that turn with realistic paper curling physics. After exploring all 12 chapters of our story and secret love notes — beginning with February 6th, the day we got engaged — the book gracefully closes in 3D with a grand celebratory confetti explosion and harmonic harp crescendo.
