/**
 * 💕 Happy Birthday Arooba — 3D Keepsake Book Engine
 * Complete 3D Experience: Closed Book ➔ Open Spread ➔ 12 Page Turns ➔ Full 3D Close & Finale
 */
(function () {
  'use strict';

  // ─── 1. Birthday Wishes Data for Arooba ─────────────────────────────
  const DEFAULT_REASONS = [
    {
      text: "Happy Birthday, my Arooba. Today the whole world should celebrate the day someone as wonderful as you was born.",
      secretNote: "Every year that passes makes me fall for you more. Watching you grow into the beautiful soul you are is my greatest joy.",
      emoji: "🎂", icon: "star",
      ...
      chapter: "Chapter I ✦ A Very Special Day",
      theme: "rose"
    },
    {
      text: "I can't wait to call you my wife, but for now, let me just say — being loved by you is my life's greatest gift.",
      secretNote: "Every quiet moment I imagine our future together, my heart fills with so much hope and happiness. You are my forever.",
      emoji: "💍", icon: "heart",
      polaroidCaption: "Dreaming of our forever",
      quote: "Soon the world will know you as my wife, but my heart already does.",
      chapter: "Chapter II ✦ My Wife-to-Be",
      theme: "navy"
    },
    {
    ...
    {
      text: "The way you see beauty in the smallest, most ordinary moments of life.",
      secretNote: "A quiet sunset, a cup of chai, a stray flower — you teach me to appreciate every sweet whisper of life.",
      emoji: "🌸", icon: "flower",
    ...
    {
      text: "How your voice is the first thing I want to hear every single morning, on this birthday and every one after.",
    ...
    {
      text: "Happy Birthday, Arooba. Simply because being with you already feels like coming home — and soon it will be, forever.",
      secretNote: "No matter where we are in the world, as long as I'm with you, I am home. Happy Birthday, my love. I love you with all my heart, forever and always.",
      emoji: "🏡", icon: "home",
